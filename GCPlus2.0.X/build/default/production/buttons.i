...
# 248 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic18f25k42.h"
...
if (toggledButtons.A) buttonsTimers[BUTTON_A_ID] = 0;
if (toggledButtons.B) buttonsTimers[BUTTON_B_ID] = 0;
if (toggledButtons.X) buttonsTimers[BUTTON_X_ID] = 0;
if (toggledButtons.Y) buttonsTimers[BUTTON_Y_ID] = 0;
if (toggledButtons.ST) buttonsTimers[BUTTON_ST_ID] = 0;
if (toggledButtons.DL) buttonsTimers[BUTTON_DL_ID] = 0;
if (toggledButtons.DR) buttonsTimers[BUTTON_DR_ID] = 0;
if (toggledButtons.DD) buttonsTimers[BUTTON_DD_ID] = 0;
if (toggledButtons.DU) buttonsTimers[BUTTON_DU_ID] = 0;
if (toggledButtons.Z) buttonsTimers[BUTTON_Z_ID] = 0;
if (toggledButtons.RD) buttonsTimers[BUTTON_RD_ID] = 0;
if (toggledButtons.LD) buttonsTimers[BUTTON_LD_ID] = 0;
if (toggledButtons.LA) buttonsTimers[BUTTON_LA_ID] = 0;
if (toggledButtons.RA) buttonsTimers[BUTTON_RA_ID] = 0;
if (toggledButtons.Z2) buttonsTimers[BUTTON_Z2_ID] = 0;
...
outButtons.byte1 = 0x80;

if (buttonsTimers[BUTTON_A_ID] >= 10 && !prevButtons.A) { buttonsTimers[BUTTON_A_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_A_ID]; } if (buttonsTimers[BUTTON_A_ID] >= 10 && !prevButtons.A) { buttonsTimers[BUTTON_A_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_A_ID]; }
if (buttonsTimers[BUTTON_B_ID] >= 10 && !prevButtons.B) { buttonsTimers[BUTTON_B_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_B_ID]; } if (buttonsTimers[BUTTON_B_ID] >= 10 && !prevButtons.B) { buttonsTimers[BUTTON_B_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_B_ID]; }
if (buttonsTimers[BUTTON_X_ID] >= 10 && !prevButtons.X) { buttonsTimers[BUTTON_X_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_X_ID]; } if (buttonsTimers[BUTTON_X_ID] >= 10 && !prevButtons.X) { buttonsTimers[BUTTON_X_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_X_ID]; }
if (buttonsTimers[BUTTON_Y_ID] >= 10 && !prevButtons.Y) { buttonsTimers[BUTTON_Y_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_Y_ID]; } if (buttonsTimers[BUTTON_Y_ID] >= 10 && !prevButtons.Y) { buttonsTimers[BUTTON_Y_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_Y_ID]; }
if (buttonsTimers[BUTTON_ST_ID] >= 10 && !prevButtons.ST) { buttonsTimers[BUTTON_ST_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_ST_ID]; } if (buttonsTimers[BUTTON_ST_ID] >= 10 && !prevButtons.ST) { buttonsTimers[BUTTON_ST_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_ST_ID]; }
if (buttonsTimers[BUTTON_DL_ID] >= 10 && !prevButtons.DL) { buttonsTimers[BUTTON_DL_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_DL_ID]; } if (buttonsTimers[BUTTON_DL_ID] >= 10 && !prevButtons.DL) { buttonsTimers[BUTTON_DL_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_DL_ID]; }
if (buttonsTimers[BUTTON_DR_ID] >= 10 && !prevButtons.DR) { buttonsTimers[BUTTON_DR_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_DR_ID]; } if (buttonsTimers[BUTTON_DR_ID] >= 10 && !prevButtons.DR) { buttonsTimers[BUTTON_DR_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_DR_ID]; }
if (buttonsTimers[BUTTON_DD_ID] >= 10 && !prevButtons.DD) { buttonsTimers[BUTTON_DD_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_DD_ID]; } if (buttonsTimers[BUTTON_DD_ID] >= 10 && !prevButtons.DD) { buttonsTimers[BUTTON_DD_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_DD_ID]; }
if (buttonsTimers[BUTTON_DU_ID] >= 10 && !prevButtons.DU) { buttonsTimers[BUTTON_DU_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_DU_ID]; } if (buttonsTimers[BUTTON_DU_ID] >= 10 && !prevButtons.DU) { buttonsTimers[BUTTON_DU_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_DU_ID]; }
if (buttonsTimers[BUTTON_Z_ID] >= 10 && !prevButtons.Z) { buttonsTimers[BUTTON_Z_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_Z_ID]; } if (buttonsTimers[BUTTON_Z_ID] >= 10 && !prevButtons.Z) { buttonsTimers[BUTTON_Z_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_Z_ID]; }
if (buttonsTimers[BUTTON_RD_ID] >= 10 && !prevButtons.RD) { buttonsTimers[BUTTON_RD_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_RD_ID]; } if (buttonsTimers[BUTTON_RD_ID] >= 10 && !prevButtons.RD) { buttonsTimers[BUTTON_RD_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_RD_ID]; }
if (buttonsTimers[BUTTON_LD_ID] >= 10 && !prevButtons.LD) { buttonsTimers[BUTTON_LD_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_LD_ID]; } if (buttonsTimers[BUTTON_LD_ID] >= 10 && !prevButtons.LD) { buttonsTimers[BUTTON_LD_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_LD_ID]; }
if (buttonsTimers[BUTTON_Z2_ID] >= 10 && !prevButtons.Z2) { buttonsTimers[BUTTON_Z2_ID] = 10; outButtons.byte0 |= buttonsMapByte0[BUTTON_Z2_ID]; } if (buttonsTimers[BUTTON_Z2_ID] >= 10 && !prevButtons.Z2) { buttonsTimers[BUTTON_Z2_ID] = 10; outButtons.byte1 |= buttonsMapByte1[BUTTON_Z2_ID]; }

if (buttonsTimers[BUTTON_LA_ID] >= 10) {
buttonsTimers[BUTTON_LA_ID] = 10;
if (prevButtons.LA) {
outButtons.LA = 0;
} else {
outButtons.LA = 0xFF;
...
if (buttonsTimers[BUTTON_RA_ID] >= 10) {
buttonsTimers[BUTTON_RA_ID] = 10;
if (prevButtons.RA) {
outButtons.RA = 0;
} else {
outButtons.RA = 0xFF;
